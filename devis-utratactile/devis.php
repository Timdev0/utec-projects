...
<html>
    ...
    <div class ="row">
      <div class="col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xs-8 offset-xs-2 bg-my2 form-marg">
        <!-- Select Basic -->
        <form id="regForm" class="form-horizontal" action="sendmail.php" method="post" accept-charset="utf-8 ">
          <fieldset>
            ...
            <div class="tab min-h marg-ltab pad-top-form">
              ...
              <!-- Text input-->
              <div class="container">
                <div class="row pad-snd">
                  <div class="form-group col-md-6 col-lg-6 col-xs-6">
                    <label class="control-label" for="mail">Email*</label>
                    <div>
                      <input id="mail" name="mail" placeholder="Email" class="form-control input-md" required="" type="text">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-6 col-lg-6 col-xs-6">
                    ...
                    <div>
                      <input id="phone" name="phone" placeholder="Téléphone" class="form-control input-md" type="text">
                    </div>
                  </div>
                </div>
              </div>
